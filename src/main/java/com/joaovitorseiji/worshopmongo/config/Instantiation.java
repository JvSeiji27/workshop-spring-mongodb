...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/08/2024"), "Partiu Viagem", "Vou viajar para SP", maria);
		Post post2 = new Post(null, sdf.parse("24/08/2024"), "Bom Dia!", "Acordei feliz hoje!", maria);
